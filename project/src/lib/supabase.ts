...
// Helper function to fetch a random recipe for quick decision
export async function fetchRandomRecipe(mealType?: string | null, userId?: string | null): Promise<Recipe | null> {
  try {
    const { data, error } = await supabase
